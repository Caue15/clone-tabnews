...
describe("POST /api/v1/users", () => {
  describe("Anonymous user", () => {
    test("With unique and valid data", async () => {
      ...
      const userInDatabase = await user.findOneByUsername("caue15");
  ...
  describe("Default user", () => {
    test("With unique and valid data", async () => {
      const user1 = await orchestrador.createUser();
      await orchestrador.activateUser(user1);
      const user1SessionObject = await orchestrador.createSession(user1.id);
